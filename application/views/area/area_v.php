            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-bottom:2px;">
				...
				<div class="form-group">
                  <label>Nama Area</label><span class="label label-danger pull-right provinsi_error"></span>
                  <input type="text" class="form-control" name="nama_area" id="nama_area" value="" placeholder="Nama Area" autocomplete="off" />
                  <input type="hidden" value="" name="id_area" id="id_area">
                </div>
...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:10%">ID Area</th>			
			<th style="text-align:center; width:50%">Nama Area</th>			
			...
			<?php 
				...
				if(!empty($brand)){		
					foreach($brand as $c){	
						...
						$info = $c['id_area'].'Þ'.$c['nama_area'];
						echo '<tr>';
						echo '<td align="center">'.$i++.'.</td>';
						echo '<td>'.$c['id_area'].'</td>';
						echo '<td>'.ucwords($c['nama_area']).'</td>';
...
$('.yes_save').click(function(){
	...
	if(provinsi <= 0 || provinsi == '') {
		$('.provinsi_error').text('Nama area harus diisi');
		return false;
	}
	
	var url = '<?php echo site_url('area/simpan');?>';
