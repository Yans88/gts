...
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table class="table table-bordered table-reponsive">
        ...
        <tr class="header_kolom">
			<th style="vertical-align: middle; text-align:center; width:33%;" >Photo KTP</th>
			<th style="vertical-align: middle; text-align:center; width:33%;" >Photo NPWP</th>
			<th style="vertical-align: middle; text-align:center; width:34%;" >History Tier</th>
		...
		<tr style="vertical-align:middle; text-align:left">
			...
			<td class="first h_tengah" align="center">
				...
				<img height="300" width="300" src="<?php echo $photo_ktp;?>"/></a> 	
			</td>
			<td class="first h_tengah" align="center">
				<a class="" href="<?php echo $photo_npwp;?>" title="Photo NPWP">	
				<img height="300" width="300" src="<?php echo $photo_npwp;?>"/></a> 	
			</td>
